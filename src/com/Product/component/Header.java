...
public class Header extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        cmdMenu = new com.Product.swing.Button();
        ...
        cmdMenu.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/Product/icon/menu.png"))); // NOI18N

        lbName.setFont(new java.awt.Font("sansserif", 1, 12)); // NOI18N
        lbName.setForeground(new java.awt.Color(127, 127, 127));
        ...
        buttonBadges1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/Product/icon/notification.png"))); // NOI18N
        buttonBadges1.setBadges(12);

        buttonBadges2.setForeground(new java.awt.Color(63, 178, 232));
        buttonBadges2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/Product/icon/message.png"))); // NOI18N
        buttonBadges2.setBadges(5);

        jSeparator2.setOrientation(javax.swing.SwingConstants.VERTICAL);

        lbExit.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/Product/icon/logout.png"))); // NOI18N
    ...
    private com.Product.swing.Button cmdMenu;
    private javax.swing.JSeparator jSeparator1;
    private javax.swing.JSeparator jSeparator2;
    private javax.swing.JLabel lbExit;
    public static final javax.swing.JLabel lbName = new javax.swing.JLabel();
